...
export interface Pagination {offset?: number; total_count?: number; count?: number}

export interface Meta {msg?: string; status?: number; response_id?: string}

export interface User {avatar_url?: string; banner_url?: string; profile_url?: string; username?: string; display_name?: string; twitter?: string}

export interface Image {url?: string; width?: string; height?: string; size?: string; frames?: string; mp4?: string; mp4_size?: string; webp?: string; webp_size?: string}

export interface Gif {type?: "gif"; id?: string; slug?: string; url?: string; bitly_url?: string; embded_url?: string; username?: string; source?: string; rating?: string; content_url?: string; tags?: string[]; featured_tags?: string[]; user?: User; source_tld?: string; source_post_url?: string; update_datetime?: string; create_datetime?: string; import_datetime?: string; trending_datetime?: string; images?: {fixed_height?: Image; fixed_height_still?: Image; fixed_height_downsampled?: Image; fixed_width?: Image; fixed_width_still?: Image; fixed_width_downsampled?: Image; fixed_height_small?: Image; fixed_height_small_still?: Image; fixed_width_small?: Image; fixed_width_small_still?: Image; downsized?: Image; downsized_still?: Image; downsized_large?: Image; downsized_medium?: Image; downsized_small?: Image; original?: Image; original_still?: Image; looping?: Image; preview?: Image; preview_gif?: Image}}
...
export interface SearchGifsResponse {data?: Gif[]; pagination?: Pagination; meta?: Meta}

export interface SearchGifsQueryParams {q: string; limit?: number; offset?: number; rating?: string; lang?: string}
...
export interface TrendingGifsResponse {data?: Gif[]; pagination?: Pagination; meta?: Meta}

export interface TrendingGifsQueryParams {limit?: number; offset?: number; rating?: string}
...
export interface TranslateGifResponse {data?: Gif; meta?: Meta}

export interface TranslateGifQueryParams {s: string}
...
export interface RandomGifResponse {data?: Gif; meta?: Meta}

export interface RandomGifQueryParams {tag?: string; rating?: string}
...
export interface GetGifByIdResponse {data?: Gif; meta?: Meta}
...
export interface GetGifsByIdResponse {data?: Gif[]; pagination?: Pagination; meta?: Meta}

export interface GetGifsByIdQueryParams {ids?: string}
...
export interface SearchStickersResponse {data?: Gif[]; pagination?: Pagination; meta?: Meta}

export interface SearchStickersQueryParams {q: string; limit?: number; offset?: number; rating?: string; lang?: string}
...
export interface TrendingStickersResponse {data?: Gif[]; pagination?: Pagination; meta?: Meta}

export interface TrendingStickersQueryParams {limit?: number; offset?: number; rating?: string}
...
export interface TranslateStickerResponse {data?: Gif; meta?: Meta}

export interface TranslateStickerQueryParams {s: string}
...
export interface RandomStickerResponse {data?: Gif; meta?: Meta}

export interface RandomStickerQueryParams {tag?: string; rating?: string}
